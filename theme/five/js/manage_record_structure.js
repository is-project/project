$(document).ready(function () {
	...
	$( "a#editRecordStructureButton" ).click(function(){
		...
		if( $( 'table.data input[type=checkbox]:checked:not(#checkall)' ).length == 1) {
			...
			var title = $( 'table.data input[type=checkbox]:checked:not(#checkall)' ).closest('tr').find('td:nth-child(3)').html()
			title = $("<div>"+title+"</div>")
			...
			var type = $( 'table.data input[type=checkbox]:checked:not(#checkall)' ).closest('tr').find('td:nth-child(4)').html();
			var length = $( 'table.data input[type=checkbox]:checked:not(#checkall)' ).closest('tr').find('td:nth-child(5)').html();
			var dec_places = $( 'table.data input[type=checkbox]:checked:not(#checkall)' ).closest('tr').find('td:nth-child(6)').html();
